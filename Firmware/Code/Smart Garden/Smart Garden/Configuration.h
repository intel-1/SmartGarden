...
extern char Text_Error_Configuration[];
...
// ======================================================================
#define CONTROLLER_AUTOMATIC_MODE 1		// Контроллер в автоматическом режиме
#define CONTROLLER_MANUAL_MODE 2		// Контроллер в ручном режиме
#define CONTROLLER_CONFIGURATION_MODE 3	// Контроллер в режиме конфигурирования
// ======================================================================
#define SENSOR_0 0
#define SENSOR_1 1
#define SENSOR_2 2
...
#define HUMM_AIR_AND_PRESS 25		// Атмосферное давление и влажность воздуха

...
extern int RealValueADC[QuantitySensors];				// Текущие значения аналоговых портов
...
extern byte SensorsError[QuantitySensors][3];			// Ошибки датчиков
//extern float SumValueSensors[QuantitySensors][3];		// Суммы измеренных значений датчиков
//extern byte QuantityCalcSensors[QuantitySensors][3];	// Количество измеренных значений датчиков

extern struct StructQuantityCalcSensors{
	float SumValue[QuantitySensors][3];					// Суммы измеренных значений датчиков ()
	byte QuantityCalc[QuantitySensors];					// Счетчик количество измеренных значений датчиков

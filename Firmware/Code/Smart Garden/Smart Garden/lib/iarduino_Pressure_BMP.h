...
#endif																			//
//
#include "../lib/iarduino_Pressure_BMP_I2C.h"											//	Подключаем файл iarduino_Pressure_BMP_I2C.h - для работы с шиной I2C        (используя функции производного класса iarduino_I2C)
//
...
class iarduino_Pressure_BMP{													//
	public:																		//
	/**	Конструктор класса **/													//
	iarduino_Pressure_BMP				(uint8_t i=0x76){objI2C = new iarduino_I2C; valAddress=i;}	//											(аргументы: адрес датчика на шине I2C)
